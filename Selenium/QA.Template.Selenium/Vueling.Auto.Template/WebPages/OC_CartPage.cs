...
{
    public class OC_CartPage : CommonPage
    {
        public OC_CartPage(ISetUpWebDriver setUpWebDriver) : base(setUpWebDriver)
        {
        }
        ...
        public OC_CartPage UpdateQuantity(int updateQuantity, string productName)
        {
        ...
        public OC_CartPage RemoveProduct(string productName)
        {
            BtnRemove(productName).Click();
            return this;
        }
        public OC_CartPage ContinueShopping()
        {
            BtnContinueShopping.Click();
            return this;
        }
        public OC_CartPage MakeCheckout()
        {
            BtnCheckout.Click();
            return this;
        }
