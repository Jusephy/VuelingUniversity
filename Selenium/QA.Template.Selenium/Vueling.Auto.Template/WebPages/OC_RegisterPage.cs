...
{
    public class OC_RegisterPage : CommonPage
    {
        public OC_RegisterPage(ISetUpWebDriver setUpWebDriver) : base(setUpWebDriver)
        {
        }
        ...
        {
            { return WebDriver.FindElementByCssSelector($"//input[@name='newsletter' and @value='{newsletterYorN}']"); }
        }
        private IWebElement CheckConfirmPrivacy
        {
            get { return WebDriver.FindElementByCssSelector("//input[@type='checkbox']"); }
        }
        private IWebElement BtnContinue
        {
            get { return WebDriver.FindElementByCssSelector("//input[@value='Continue']"); }
        }
        int newsletterYorN;
        public OC_RegisterPage RegisterUser(string firstName, string lastName, string email, int telephone, string password, bool YorN)
        {
